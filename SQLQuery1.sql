--create database db_RequerimientoEna_20_07_2020;
--use db_RequerimientoEna_20_07_2020
...
num_asignar int, 
primary key(num),
foreign key(num_asignar) references tb_asignar(num)
)
go
...
insert into requerimiento (numgerencia,numdpto,numasignar,numencargado, requerimiento.requerimiento )
values (1,3,5,4,'Ena web');

truncate table tb_encargado;



update tb_encargado set num_asignar = 5 where num = 5
